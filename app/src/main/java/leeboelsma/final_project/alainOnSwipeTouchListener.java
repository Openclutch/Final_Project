 ...
 * adapted from Stack Overflow Thread:
 * http://stackoverflow.com/questions/4139288/android-how-to-handle-right-to-left-swipe-gestures
 *
 */
public class alainOnSwipeTouchListener implements View.OnTouchListener {

    private final GestureDetector gestureDetector;

    public alainOnSwipeTouchListener(Context context) {
